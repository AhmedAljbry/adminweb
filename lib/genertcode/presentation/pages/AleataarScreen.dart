...
class Aleataarscreen extends StatefulWidget {
  final AppConfigController configController;
  const Aleataarscreen({super.key, required this.configController});

  @override
  State<Aleataarscreen> createState() => _Aleataarscreen();
}

class _Aleataarscreen extends State<Aleataarscreen> {
  ...
  // ثيم ثابت
  late final ThemeData _fixedTheme;

  // علشان ما نفتح دايلوج النجاح أكثر من مرة
  ...
  void initState() {
    ...
    _fixedTheme = ThemeData(
      useMaterial3: true,
      brightness: Brightness.light,
      colorSchemeSeed: c.primaryColor,
      fontFamily: 'Roboto',
    );
  }
      ...
      child: Directionality(
        ...
        child: BlocConsumer<GenCodeBloc, GenCodeState>(
          listener: (context, state) async {
            ...
            // نجاح + عندنا نتيجة وبالذات مسار ملف
              ...
              await showDialog(
                ...
                builder: (_) => AlertDialog(
                  ...
                  content: Column(
                    ...
                    children: [
                      Text('عدد المعرّفات المطلوبة: ${result.requestedCount}'),
                      Text(
                ...
                child: Center(
                  child: ConstrainedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        // ✅ شعار ديناميكي (شبكة أو أصول)
                        _BrandLogo(url: widget.configController.config.logoUrl),
                        const SizedBox(height: 20),

                        Text(
                          widget.configController.config.appTitle,
